...
> 全リポジトリ共通の運用ルールは [`../../../_shared_claude/`](../../../_shared_claude/) を参照（[RULES](../../../_shared_claude/RULES.md)・[AGENTS](../../../_shared_claude/AGENTS.md)・[DB](../../../_shared_claude/DB.md)・[REPORT](../../../_shared_claude/REPORT.md)・[PROJECT_TYPES](../../../_shared_claude/PROJECT_TYPES.md)）。timecard = **Type C（Firebase + GitHub Pages）**（**DB.md は汎用安全原則のみ・RLS/migration 非適用**。Firebase Rules・SW・通知を慎重にレビュー）。固有部は本ファイル/AGENTS.md を優先。
